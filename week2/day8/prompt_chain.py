...
def step1_res_extract(RESUME):
    ...
    Also give answer without any decoration or formatting. Just return the skills in a single line without any extra text.
    """
    user_prompt=f"""
...
def step3_match(candidate,jd):
    print("step3")
    system_prompt="""
    You are a professional HR assistant. compare the skills of candidate and the skills required in the JD and produce a final score between 1 and 100. also produce a short verdict whther the candidate is a good fit for the role.
    """
    user_prompt=f"""
